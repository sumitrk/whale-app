...
| 2 | R-SET-01 | Reuse one shortcut-label formatter | queued | `KeyRecorderView.swift`, possibly settings tests | Fn/Globe, Escape, arrows, ordinary keys, modifiers |
| 3 | R-TRN-02 | Centralize VAD minimum-duration policy | queued | VAD editor/stage/tests | Decide threshold; boundary tests; full Xcode test |
